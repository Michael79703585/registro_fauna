...
{
    // Función privada para obtener IDs de usuarios de la institución del usuario actual
    private function obtenerUsuariosInstitucion()
    {
        $user = Auth::user();
        return \App\Models\User::where('institucion_id', $user->institucion_id)->pluck('id');
    }

    public function index(Request $request)
    {
        $usuariosInstitucionIds = $this->obtenerUsuariosInstitucion();

        $query = Liberacion::whereIn('user_id', $usuariosInstitucionIds);
        ...
        return view('liberaciones.index', compact('liberaciones'))->with('filters', $request->all());
    }
    ...
    public function create()
    {
        ...
        $faunaRegistradaIds = Fauna::whereIn('user_id', $usuariosInstitucionIds)->pluck('id');
    ...
    public function edit(Liberacion $liberacion)
    {
        ...
        return view('liberaciones.edit', compact('liberacion', 'faunas'));
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        $usuariosInstitucionIds = $this->obtenerUsuariosInstitucion();
        $filters['user_ids'] = $usuariosInstitucionIds->toArray();
