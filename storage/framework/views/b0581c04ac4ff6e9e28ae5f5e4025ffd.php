...
<?php $__env->startSection('title', 'Listado de Partes'); ?>
...
<div class="bg-white shadow rounded-lg p-6">
    ...
    <div class="flex flex-wrap items-center justify-between mb-6 gap-4">
        <a href="<?php echo e(route('partes.create')); ?>"
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('partes.exportPdf')); ?>"
            ...
            <a href="<?php echo e(route('partes.exportExcel')); ?>"
    ...
    <form action="<?php echo e(route('partes.index')); ?>" method="GET"
    ...
    <div class="overflow-auto">
        <table class="min-w-full text-sm text-left border-collapse border border-gray-300">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $partes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-b hover:bg-blue-50 transition">
                        <td class="px-3 py-2 border"><?php echo e($parte->codigo ?? 'N/A'); ?></td>
                        <td class="px-3 py-2 border"><?php echo e(ucfirst(str_replace('_', ' ', $parte->tipo_registro))); ?></td>
                        <td class="px-3 py-2 border"><?php echo e(\Carbon\Carbon::parse($parte->fecha_recepcion)->format('d/m/Y')); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->ciudad); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->departamento); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->coordenadas); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->tipo_elemento); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->motivo_ingreso); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->institucion_remitente); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->nombre_persona_recibe); ?></td>
                        <td class="px-3 py-2 border italic"><?php echo e($parte->especie); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->nombre_comun); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->tipo_animal); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->cantidad); ?></td>
                        <td class="px-3 py-2 border"><?php echo e(\Carbon\Carbon::parse($parte->fecha)->format('d/m/Y')); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->disposicion_final); ?></td>
                        <td class="px-3 py-2 border"><?php echo e($parte->observaciones); ?></td>

                        <td class="px-3 py-2 border text-center">
                            <?php if($parte->foto && file_exists(public_path('storage/partes_fotos/' . $parte->foto))): ?>
                                <img src="<?php echo e(asset('storage/partes_fotos/' . $parte->foto)); ?>" alt="Foto" class="w-32 h-32 rounded shadow">
                            <?php else: ?>
                        ...
                        <td class="px-3 py-2 border text-center flex flex-col items-center space-y-2">
                            <a href="<?php echo e(route('partes.show', $parte->id)); ?>"
                            ...
                            <a href="<?php echo e(route('partes.duplicar', $parte->id)); ?>"
                                class="inline-flex items-center gap-1 px-2 py-1 rounded bg-blue-600 text-white hover:bg-blue-700 text-xs shadow"
                            ...
                            <form action="<?php echo e(route('partes.destroy', $parte->id)); ?>" method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registro_fauna\resources\views/partes/index.blade.php ENDPATH**/ ?>