...
<div class="mb-4">
    ...
    <input type="text" name="<?php echo e($name); ?>" id="<?php echo e($name); ?>" value="<?php echo e(old($name, $value)); ?>" <?php echo e($attributes->merge(['class' => 'w-full border-gray-300 rounded-md shadow-sm'])); ?>>
...
<?php /**PATH C:\laragon\www\registro_fauna\resources\views/components/input-field.blade.php ENDPATH**/ ?>