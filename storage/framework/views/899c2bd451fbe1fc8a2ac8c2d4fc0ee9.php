...
<?php $__env->startSection('title', 'Historiales Clínicos'); ?>
  ...
  <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 flex items-center gap-3">
    ...
    HISTORIALES CLÍNICOS
        ...
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('historial.create')); ?>"
            ...
            <a href="<?php echo e(route('historial.reportePdf', ['buscar' => request('buscar')])); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('historial.reporteExcel', ['buscar' => request('buscar')])); ?>" target="_blank"
...
<tr class="hover:bg-gray-50 transition <?php echo e($fueTransferida ? 'bg-green-100 text-green-800 font-medium' : ''); ?>">
        <td class="px-4 py-3 font-mono text-blue-900"><?php echo e($historial->fauna->codigo); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->fecha_recepcion); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->departamento); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->ciudad); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->tipo_animal); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->nombre_comun); ?></td>
        <td class="px-4 py-3 italic"><?php echo e($historial->fauna->especie); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->edad_aparente); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->sexo); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->comportamiento); ?></td>
        <td class="px-4 py-3"><?php echo e($historial->fauna->otras_observaciones); ?></td>
        <td class="px-4 py-3"><?php echo e(\Carbon\Carbon::parse($historial->fecha)->format('Y-m-d')); ?></td>
        <td class="px-4 py-3"><?php echo e(Str::limit($historial->diagnostico, 50)); ?></td>
        <td class="px-4 py-3"><?php echo e(Str::limit($historial->tratamiento, 50)); ?></td>
        <td class="px-4 py-3"><?php echo e(Str::limit($historial->observaciones, 50)); ?></td>
        <td class="px-4 py-3">
                        <div class="flex flex-wrap gap-2">
                            <a href="<?php echo e(route('historial.show', $historial->id)); ?>" 
                            ...
                            <a href="<?php echo e(route('historial.pdf', $historial->id)); ?>" 
                               target="_blank"
                            ...
                            <a href="<?php echo e(route('historial.duplicate', $historial->id)); ?>" 
                            ...
                            <form action="<?php echo e(route('historial.destroy', $historial->id)); ?>" method="POST" 
    ...
    <div class="mt-6">
        <?php echo e($historiales->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registro_fauna\resources\views/historial/index.blade.php ENDPATH**/ ?>