...
<?php $__env->startSection('title', 'Detalle de Liberación'); ?>
...
<div class="max-w-6xl mx-auto p-6 bg-white rounded-xl shadow-lg space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <?php $__currentLoopData = $campos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $valor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 shadow-sm">
                ...
                <p class="text-gray-800 mt-1 <?php echo e(Str::contains($label, 'Especie') ? 'italic' : ''); ?>">
                    <?php echo e($valor); ?>
        ...
        <div class="md:col-span-2 p-4 bg-gray-50 rounded-lg border border-gray-200 shadow-sm">
            ...
            <p class="text-gray-800 mt-1 whitespace-pre-line"><?php echo e($liberacion->observaciones ?? '—'); ?></p>
        </div>
    </div>
    ...
    <div class="text-center mt-8">
        ...
        <?php if($liberacion->foto && file_exists(storage_path('app/public/' . $liberacion->foto))): ?>
            <img src="<?php echo e(asset('storage/' . $liberacion->foto)); ?>" alt="Fotografía de la liberación"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registro_fauna\resources\views/liberaciones/show.blade.php ENDPATH**/ ?>