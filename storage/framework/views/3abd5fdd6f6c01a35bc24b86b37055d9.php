...
<?php $__env->startSection('title', 'Decesos'); ?>
...
<div class="form-container shadow-sm">
    ...
    <form action="<?php echo e(route('eventos.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
        <?php echo csrf_field(); ?>
        <input type="hidden" name="tipo_evento_id" value="<?php echo e($tiposEvento->firstWhere('nombre', 'Deceso')->id); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="especie" id="especie" class="form-control" style="font-style: italic;" value="<?php echo e(old('especie')); ?>" readonly>
...
<div class="col-md-4">
    ...
    <input type="text" name="nombre_comun" id="nombre_comun" class="form-control" value="<?php echo e(old('nombre_comun')); ?>" readonly>
</div>

         <!-- Sexo -->
<div class="col-md-4">
    <label for="sexo_display" class="form-label">Sexo</label>
    <input type="text" id="sexo_display" class="form-control" readonly value="<?php echo e(old('sexo')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-8">
                ...
                <textarea name="causas_deceso" id="causas_deceso" rows="3" class="form-control <?php $__errorArgs = ['causas_deceso'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('causas_deceso')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Hidden codigo -->
            <input type="hidden" name="codigo" id="codigo" value="<?php echo e(old('codigo', '')); ?>">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registro_fauna\resources\views/eventos/create_deceso.blade.php ENDPATH**/ ?>